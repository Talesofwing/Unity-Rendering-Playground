...
4. [Outline-Based-Fresnel](OutlineBasedFresnel.md)
...
7. [5 ways to draw an outline](https://alexanderameye.github.io/notes/rendering-outlines/) (This post provides detailed information on 5 methods for rendering Outline.)