...
It is a fake [BRDF](https://en.wikipedia.org/wiki/Bidirectional_reflectance_distribution_function) texture.
...
The following image is a Ramp Texture(1D).

![1d](/Imgs/TexEffects/RampTex/ramp_1d.jpg)
...
The following image is a Ramp Texture(2D) from the 《Unity Shaders and Effects Cookbook》.

![2d](/Imgs/TexEffects/RampTex/ramp_2d.jpg)